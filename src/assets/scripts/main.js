...
! function (a) {
	...
	function m(a, b, c, d, e, f) {         
		for (var g = "", h = 1; 10 > h; h++) g += '<option value="' + h + '"' + (d === h ? "selected" : "") + ">" + h + " product</option>";
	...
	if (g(), l(), k(), a(".addToCart").on("click", function (b) {
		...
		H.each(function () {
			...
			b.countdown(c, function (a) {
				b.html(a.strftime('<div class="time-circle"><h3>%D</h3><h5>days</h5></div><div class="time-circle"><h3>%H</h3><h5>hours</h5></div><div class="time-circle"><h3>%M</h3><h5>minutes</h5></div><div class="time-circle"><h3>%S</h3><h5>seconds</h5></div>'))
			})
		})
	}
